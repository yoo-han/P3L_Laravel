...
Route::post('rating/{id}','App\\Http\\Controllers\\Api\\CustomerController@updateRating');
Route::resource('driver',DriverController::class);
Route::post('driver/{id}','App\\Http\\Controllers\\Api\\DriverController@update');
Route::post('updateProfileDriver/{id}','App\\Http\\Controllers\\Api\\DriverController@updateProfile');
...
Route::post('updateProfilePegawai/{id}','App\\Http\\Controllers\\Api\\PegawaiController@updateProfile');
...
Route::get('reservasiDriver/{id_driver}','App\\Http\\Controllers\\Api\\ReservasiMobilController@showDriver');
Route::get('laporanBulananMobil/{bulan}/{tahun}', 'App\Http\Controllers\Api\LaporanController@penyewaanMobil');
Route::get('laporanBulananDetailPendapatan/{bulan}/{tahun}', 'App\Http\Controllers\Api\LaporanController@pendapatanTransaksi');
Route::get('laporanBulananTransaksiDriver/{bulan}/{tahun}', 'App\Http\Controllers\Api\LaporanController@jumlahTransaksiDriver');
Route::get('laporanBulananPerformaDriver/{bulan}/{tahun}', 'App\Http\Controllers\Api\LaporanController@performaDriver');
Route::get('laporanBulananTransaksiCustomer/{bulan}/{tahun}', 'App\Http\Controllers\Api\LaporanController@jumlahTransaksiCustomer');